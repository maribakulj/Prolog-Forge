...
//!
//! Every patch in Prolog Forge can be rejected or accepted. The epistemic
...
//! own none of them makes the decision legible. `pf-explain` composes those
...
//! `pf-graph`, `pf-rules`, and `pf-protocol`.
