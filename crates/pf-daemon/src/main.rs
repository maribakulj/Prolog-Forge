//! Prolog Forge daemon — a stdio JSON-RPC 2.0 server.
//!
...
use pf_protocol::{read_frame, write_frame, FramingError, Request, Response, RpcError};
    ...
    loop {
        ...
        let response = match parsed {
            Ok(req) => {
                ...
                let is_shutdown = method == pf_protocol::METHOD_SHUTDOWN;
